...
# other software
apt-get install p7zip-full p7zip-rar mupdf ranger chromium ncdu xfce4-terminal gnome-disk-utility aria2 htop bleachbit thunar gvfs-fuse gvfs-backends ssh nethogs tree rsync libreoffice alsa-utils geany mirage
