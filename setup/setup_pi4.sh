...
# other software
apt-get install p7zip-full p7zip-rar mupdf ranger surf firefox-esr ncdu aria2 htop bleachbit pcmanfm ssh nethogs tree rsync libreoffice-writer libreoffice-impress libreoffice-calc geany feh powertop xarchiver audacity gimp scribus youtube-dl inkscape r-base cups 
